...
const addNote = (title,body) =>{
    ...
    // Debugger statements are used to pause the execution of the code at specific points, 
    // allowing developers to inspect variables and understand the flow of the program.
    // chrome://inspect/
    // In this case, 
    // the debugger statement is placed before the duplicate note check to allow us to inspect the notes array 
    // and the duplicateNote variable.
    debugger
